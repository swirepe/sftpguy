...
func (m *serverMetrics) StatsSnapshot() adminhttp.StatsSnapshot {
	...
	snap.SFTPListTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "list"})
	snap.SFTPStatTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "stat"})
	snap.SFTPLstatTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "lstat"})
	snap.SFTPMkdirTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "mkdir"})
	snap.SFTPRemoveTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "remove"})
	snap.SFTPRmdirTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "rmdir"})
	snap.SFTPRenameTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "rename"})
	snap.SFTPSetstatTotal = sumCounterFamily(index["sftpguy_sftp_requests_total"], map[string]string{"operation": "setstat"})
	snap.SFTPRequestAverageSeconds = averageHistogramFamily(index["sftpguy_sftp_request_duration_seconds"], nil)
